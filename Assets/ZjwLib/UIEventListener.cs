...
public class UIEventListener : MonoBehaviour
{
	...
	static public UIEventListener Get(Transform tran)
	{
		UIEventListener listener = tran.GetComponent<UIEventListener>();
		if (listener == null) listener = tran.gameObject.AddComponent<UIEventListener>();
		return listener;
	}
}
